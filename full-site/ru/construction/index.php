			...
			<div class="status-page__inner">
				...
				<div class="status-page__descr-wrap">
					<div class="status-page__descr-inner">
						<h1 class="status-page__heading">Cтатус работ</h1>
						<p class="status-page__description" style="font-size: 0.875em;">
						Завершены работы по устройству наружной кирпичной кладки. Ведутся работы по устройству внутренних перегородок.</p>
					</div>
				</div>
