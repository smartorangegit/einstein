...
Монтаж окон на 9-м этаже. Продолжается утепления фасада. Проводятся работы по устройству кирпичных внутренних перегородок цокольных и мансардных этажей.
Продолжается прокладка внутренних электросетей и монтаж сантехнического оборудования на 9 этаже. На 1 этаже выполнены работы по гидроизоляции. Начато заливку стяжек на 7 этаже.
</p>
<style>
.status-page__heading {margin-top: -30px;}
.status-page__descr-inner {margin: 1px 0 0 auto;}
</style>
					</div>
				</div>
