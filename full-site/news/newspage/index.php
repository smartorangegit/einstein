    ...
    <main class="content news-page">
        <div class="news-page__inner">
            <div class="news-page__page-caption">
                <h2 class="news-page__caption">Новини</h2>
            </div>
            <div class="news-page__page-description">
                <div class="news-page__date-time-wrap">
                    ...
                    <div class="news-page__content-description"><?=$myrow['name_news_ua'];?></div>
                </div>
                <!-- <h1 class="news-page__content-description">Будівельні роботи</h1> -->
