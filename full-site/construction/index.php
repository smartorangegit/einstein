				...
				<div class="status-page__descr-wrap">
					<div class="status-page__descr-inner">
						...
						<p class="status-page__description" style="font-size: 0.875em;">
							Ведуться роботи по монтажу вікон та утепленню фасаду. Продовжуються роботи з улаштування цегляних внутрішніх перегородок. Розпочато монтаж пасажирського ліфта.
						</p>
					</div>
				</div>
<style>
