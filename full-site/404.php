...
<head>
	<meta charset="UTF-8">
	<title>Страница не найдена | EINSTEIN Concept House</title>
...
<body>
    ...
    <main class="content not_found_page">
        <div class="not_found_page__container">
            <h1 class="not_found_page__main-heading">404</h1>
            <div>СТРАНИЦА НЕ НАЙДЕНА!</div>
			<p class="not_found_page__main-message">Страница ,которую вы ищете, возможно была удалена, ее название было изменено, или временно недоступна.</p>
...
<head>
	<meta charset="UTF-8">
	<title>Сторінка не знайдена | EINSTEIN Concept House</title>
...
<body>
    ...
    <main class="content not_found_page">
        <div class="not_found_page__container">
            <h1 class="not_found_page__main-heading">404</h1>
            <div>ШКОДА, СТОРІНКА НЕ ЗНАЙДЕНА!</div>
            <p class="not_found_page__main-message">Сторінка, яку ви шукаєте, можливо, була видалена, її назва була змінена, або тимчасово недоступна.</p>
