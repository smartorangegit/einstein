...
<head>
	<meta charset="UTF-8">
	<title>Select-apartment | Floor-<?=$_GET['floor'];?></title>
	<meta name="description" content="">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">
	<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
	<link rel="alternate" hreflang="ua" href="https://einstein.house<?php echo $_SERVER['REQUEST_URI'];?>" />
		...
		<main class="content select-apartment">
			<div class="select-apartment__inner">
				<div class="select-apartment__caption-wrap">
					<h2 class="select-apartment__caption">Оберіть квартиру на схемі</h2>
				</div>
				...
				<div class="select-apartment__change-wrap">
					...
					<div class="select-apartment__change-floor">
						<button onclick="myFunctionPlus()"  class="select-apartment__change-floor-next">
							<img src="img/apartment/arrow-up.svg" alt="arrow-up">
						</button>
						<div class="select-apartment__change-floor-inner">
							<span><?php if(empty($_GET['floor']) || $_GET['floor'] == 0 || $_GET['floor'] == 1){echo 2;}else{  echo $_GET['floor']; }?></span>
							<p>поверх</p>
						</div>
						<button onclick="myFunctionMinus()" class="select-apartment__change-floor-prev">
...
<?}
elseif($_GET["floor"] >= 7 && $_GET["floor"] <=8 ){?>
<div class="select-apartment__apartments-inner">
